...
export const AlphaQubitContent: React.FC = () => {
      ...
      <header className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <a 
            ...
            className="inline-block mb-4 px-3 py-1 border border-nobel-gold text-nobel-gold text-xs tracking-[0.2em] uppercase font-bold rounded-full backdrop-blur-sm bg-white/30 hover:bg-white/60 transition-colors cursor-pointer"
          >
            Nature • Nov 2024 ↗
          </a>
